# LIVING DESIGN DOCUMENT: WAYPOINT (PROJECT BIBLE V1)
...
- **v0.1.0 (Direct File Previewer & Utilities):**
...
- **v0.2.0 (Custom Presets & Bookmarks):**
  - Pin favorite repositories to the top of the grid.
